...
unset($__errorArgs, $__bag); ?>" 
                    id="exampleFormControlInput1" name="genre" value="<?php echo e(old('genre')); ?>">
...
unset($__errorArgs, $__bag); ?>" 
                    id="exampleFormControlInput1" name="author" value="<?php echo e(old('author')); ?>">
...
unset($__errorArgs, $__bag); ?>
        ...
        <div class="mb-3">
            ...
            <input type="text" 
                class="form-control <?php $__errorArgs = ['publication'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?>
...
unset($__errorArgs, $__bag); ?>" 
                    id="exampleFormControlInput1" name="publication" value="<?php echo e(old('publication')); ?>">
...
unset($__errorArgs, $__bag); ?>
        ...
        <div class="mb-3">
            ...
            <input type="text" 
                class="form-control <?php $__errorArgs = ['halaman'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?>
...
unset($__errorArgs, $__bag); ?>" 
                    id="exampleFormControlInput1" name="halaman" value="<?php echo e(old('halaman')); ?>">
...
unset($__errorArgs, $__bag); ?>" 
                    id="exampleFormControlInput1" name="stock" value="<?php echo e(old('stock')); ?>">
...
unset($__errorArgs, $__bag); ?>"
                id="exampleFormControlTextarea1" rows="10" name="description"><?php echo e(old('description')); ?></textarea>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\My Device\Downloads\minilibrary\resources\views/books/create.blade.php ENDPATH**/ ?>