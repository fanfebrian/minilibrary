...
<div class="col-lg-12 d-flex align-items-stretch">
  <div class="card w-100">
    ...
    <form action="/dashboard/peminjaman" method="post" enctype="multipart/form-data">
        <?php echo csrf_field(); ?>
        <div class="mb-3">
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\My Device\Downloads\minilibrary\resources\views/booking/create.blade.php ENDPATH**/ ?>