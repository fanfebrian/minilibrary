...
<?php $__env->startSection('main'); ?>
    ...
    <div class="row">
        <div class="col-lg-12 my-3">
            <h2><a href="/dashboard/peminjaman"><i class="ti ti-arrow-left"></i></a> Detail Peminjam</h2>
        </div>
    </div>
    <div class="row">
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\My Device\Downloads\minilibrary\resources\views/booking/show.blade.php ENDPATH**/ ?>