...
unset($__errorArgs, $__bag); ?>" 
                    id="exampleFormControlInput1" name="name" value="<?php echo e(old('name', $booking->name)); ?>">
...
unset($__errorArgs, $__bag); ?>" 
                        id="exampleFormControlInput1" name="profesi" value="<?php echo e(old('profesi', $booking->profesi)); ?>">
...
unset($__errorArgs, $__bag); ?>" 
                        id="exampleFormControlInput1" name="title" value="<?php echo e(old('title', $booking->title)); ?>">
...
unset($__errorArgs, $__bag); ?>" 
                        id="exampleFormControlInput1" name="publisher" value="<?php echo e(old('publisher', $booking->publisher)); ?>">
...
unset($__errorArgs, $__bag); ?>" 
                        id="exampleFormControlInput1" name="jumlah" value="<?php echo e(old('jumlah', $booking->jumlah)); ?>">
