    ...
    <form action="/dashboard/users" method="post" enctype="multipart/form-data">
        ...
        <div class="mb-3">
            ...
            <input type="text"
                ...
                is-invalid
                @enderror" 
                    id="exampleFormControlInput1" name="genre" value="{{ old('genre') }}">
                @error('genre')
                    <p style="color: red;">{{ $message }}</p>
                @enderror
        </div>
        <div class="mb-3">
            ...
            <input type="text" 
                ...
                is-invalid
                @enderror" 
                    id="exampleFormControlInput1" name="author" value="{{ old('author') }}">
                @error('author')
                    <p style="color: red;">{{ $message }}</p>
                @enderror
        </div>
        ...
        <div class="mb-3">
            ...
            <input type="text" 
                ...
                is-invalid
                @enderror" 
                    id="exampleFormControlInput1" name="publication" value="{{ old('publication') }}">
                @error('publication')
                    <p style="color: red;">{{ $message }}</p>
                @enderror
        </div>
